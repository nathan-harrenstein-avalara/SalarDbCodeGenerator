...
namespace SalarDbCodeGenerator.Presentation
{
    public partial class frmProjectDetails : frmBase
    {
        ...
        private bool TestSqlConnection(string connStr)
        {
            try {
        ...
        private bool TestSqlCeConnection(string connStr)
        {
            try {
        ...
        private bool TestSQLiteConnection(string connStr, string sqlitePassword)
        {
            try {
        ...
        private bool TestPgConnection(string connStr)
        {
            try {
        ...
        private bool TestMysqlConnection(string connStr)
        {
            try {
        ...
        private void MoreOptionsExpand(bool expanded)
        {
