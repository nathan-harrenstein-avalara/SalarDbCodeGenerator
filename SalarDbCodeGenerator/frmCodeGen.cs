...
namespace SalarDbCodeGenerator
{
    public partial class frmCodeGen : Form
    {
        ...
        private bool _canFireEvents = false;
        private bool _suppressItemChecked = false;
        private bool _currentProject_Modified = false;
        private bool _currentProject_Opened = false;
        private string _currentProject_Filename = "";
        private ProjectDefinition _projectDefinaton;
        private PatternProject _patternProject;
        private RecentProjects _recentProjects;
        private List<PatternProject> _patternProjectsList = new List<PatternProject>();
        ...
        private void ProccessCommandLine()
        {
        ...
        private void Reload_ProjectDefinaton()
        {
        ...
        private void Reload_ProjectDefinaton(string patternProjectFile)
        {
        ...
        private void Reload_DatabaseCache()
        {
        ...
        #endregion Loading data from dataSource
        ...
        private void Refresh_Form(bool newProject)
        {
        ...
        private void Refresh_DatabaseCache()
        {
        ...
        private void Refresh_ProjectDefinaton()
        {
            if (_projectDefinaton == null)
                return;
        ...
        private void Refresh_PatternsList()
        {
            Refresh_PatternsList(false);
        }

        private void Refresh_PatternsList(bool applyAllAsSelected)
        {
        ...
        private void Refresh_GenerateFiles()
        {
            if (_projectDefinaton == null)
                return;
        ...
        private void Refresh_PatternProjectsCombo()
        {
        ...
        #endregion Refreshing presentation data
        ...
        private void UiAction_ProjectOptions()
        {
        ...
        private void UiAction_OpenProjectDirect(string projectFile)
        {
        ...
        private void UiAction_OpenProject()
        {
        ...
        private bool UiAction_SaveProject()
        {
        ...
        private void UiAction_SaveAsProject()
        {
